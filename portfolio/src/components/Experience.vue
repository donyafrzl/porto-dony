  ...
  <section id="experience" class="py-20 px-4 bg-white">
    <div class="max-w-6xl mx-auto">
      ...
      <div class="space-y-8">
        ...
        >
          <div class="absolute top-0 left-0 w-full h-1 rounded-t-2xl bg-gradient-to-r from-blue-500 to-purple-500 opacity-0 group-hover:opacity-100 transition-opacity"></div>
          ...
          <ul class="space-y-2 mb-4">
            <li v-for="(point, i) in exp.points" :key="i" class="flex items-start gap-3 text-slate-600">
